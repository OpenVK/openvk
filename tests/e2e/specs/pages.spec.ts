...
test.describe('Group wiki notes', () => {
  ...
  test('shows page history', async ({ page }) => {
    await page.goto('/note-1_1/history');
  ...
  test('creates a new page', async ({ page }) => {
    ...
    await page.waitForURL(/\/note-1_\d+/);
...
test.describe('Group wiki notes permissions', () => {
