...
use openvk\Web\Models\Repositories\{Clubs, Users, Albums, Videos, Managers, Topics, Audios, Posts, Documents};
...
final class GroupPresenter extends OpenVKPresenter
{
    ...
    public function renderView(int $id): void
    {
        ...
        if (!$club) {
            ...
            if ($club->isBanned()) {
                ...
                $this->template->videos      = (new Videos())->getByUser($club, 1, 2);
                $this->template->videosCount = (new Videos())->getUserVideosCount($club);
            }
            ...
            $this->template->canBeModified = $club->canBeModifiedBy($this->user->identity);
    ...
    public function renderEdit(int $id): void
    {
        ...
        if ($_SERVER["REQUEST_METHOD"] === "POST") {
            ...
            $club->setEveryone_can_upload_videos(empty($this->postParam("upload_videos")) ? 0 : 1);
            $club->setIs_messages_enabled(empty($this->postParam("is_messages_enabled")) ? 0 : 1);
