...
return (function () {
    ...
    if (OPENVK_ROOT_CONF["openvk"]["vk"]["enabled"] ?? false) {
        class_alias(
            "openvk\\Web\\Models\\VK\\Repositories\\Users",
            "openvk\\Web\\Models\\Repositories\\Users",
            true,
        );
        class_alias(
            "openvk\\Web\\Models\\VK\\Repositories\\Clubs",
            "openvk\\Web\\Models\\Repositories\\Clubs",
            true,
        );
        class_alias(
            "openvk\\Web\\Models\\VK\\Repositories\\Posts",
            "openvk\\Web\\Models\\Repositories\\Posts",
            true,
        );
        class_alias(
            "openvk\\Web\\Models\\VK\\Repositories\\Photos",
            "openvk\\Web\\Models\\Repositories\\Photos",
            true,
        );
        class_alias(
            "openvk\\Web\\Models\\VK\\Repositories\\Videos",
            "openvk\\Web\\Models\\Repositories\\Videos",
            true,
        );
        class_alias(
            "openvk\\Web\\Models\\VK\\Repositories\\Audios",
            "openvk\\Web\\Models\\Repositories\\Audios",
            true,
        );
        class_alias(
            "openvk\\Web\\Models\\VK\\Repositories\\Albums",
            "openvk\\Web\\Models\\Repositories\\Albums",
            true,
        );
        class_alias(
            "openvk\\Web\\Models\\VK\\Repositories\\Notes",
            "openvk\\Web\\Models\\Repositories\\Notes",
            true,
        );
        class_alias(
            "openvk\\Web\\Models\\VK\\Repositories\\Topics",
            "openvk\\Web\\Models\\Repositories\\Topics",
            true,
        );
        class_alias(
            "openvk\\Web\\Models\\VK\\Repositories\\Documents",
            "openvk\\Web\\Models\\Repositories\\Documents",
            true,
        );
        class_alias(
            "openvk\\Web\\Models\\VK\\Repositories\\Messages",
            "openvk\\Web\\Models\\Repositories\\Messages",
            true,
        );
        class_alias(
            "openvk\\Web\\Models\\VK\\Repositories\\Applications",
            "openvk\\Web\\Models\\Repositories\\Applications",
            true,
        );
        class_alias(
            "openvk\\Web\\Models\\VK\\Repositories\\Comments",
            "openvk\\Web\\Models\\Repositories\\Comments",
            true,
        );
    }
    });
